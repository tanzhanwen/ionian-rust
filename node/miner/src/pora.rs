...
pub const BYTES_PER_LOADING: usize = 256 * KB;
pub const BYTES_PER_PRICING: usize = 8 * GB;
pub const BYTES_PER_MAX_MINING_RANGE: usize = 8 * TB;

pub const SECTORS_PER_LOADING: usize = BYTES_PER_LOADING / BYTES_PER_SECTOR;
...
pub const SEALS_PER_LOADING: usize = BYTES_PER_LOADING / BYTES_PER_SEAL;
