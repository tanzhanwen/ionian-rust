...
mod tests {
    ...
    fn test_add() {
        ...
        assert_eq!(tx_store.add(&store, None, 2).unwrap(), true);
        assert_eq!(tx_store.add(&store, None, 3).unwrap(), true);

        // cannot add again
        assert_eq!(tx_store.add(&store, None, 1).unwrap(), false);
        assert_eq!(tx_store.add(&store, None, 2).unwrap(), false);
        assert_eq!(tx_store.add(&store, None, 3).unwrap(), false);
    ...
    fn test_remove_tail() {
        ...
        assert_eq!(tx_store.remove(&store, None, 3).unwrap(), true);
    ...
    fn test_remove_swap() {
        ...
        assert_eq!(tx_store.add(&store, None, 2).unwrap(), true);
        assert_eq!(tx_store.add(&store, None, 3).unwrap(), true);
        assert_eq!(tx_store.add(&store, None, 4).unwrap(), true);

        assert_eq!(tx_store.remove(&store, None, 2).unwrap(), true);
