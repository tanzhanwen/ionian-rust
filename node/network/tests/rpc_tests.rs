...
async fn test_status_rpc() {
    // get sender/receiver
    let (mut sender, mut receiver) = common::build_node_pair().await;
...
#[traced_test]
#[allow(clippy::single_match)]
async fn test_data_by_hash_chunked_rpc() {
...
#[tokio::test]
#[traced_test]
async fn test_data_by_hash_chunked_rpc_terminates_correctly() {
