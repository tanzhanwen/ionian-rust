...
fn bitmap_truncate() {
    ...
    assert_eq!(bitmap.get(10), true);
    assert_eq!(bitmap.get(29), true);
    assert_eq!(bitmap.get(30), false);
    assert_eq!(bitmap.get(55), false);
}
...
fn bitmap_big_truncate() {
    ...
    assert_eq!(bitmap.get(110), true);
    assert_eq!(bitmap.get(129), true);
    assert_eq!(bitmap.get(130), false);
    assert_eq!(bitmap.get(155), false);
    assert_eq!(bitmap.get(299), false);
}
